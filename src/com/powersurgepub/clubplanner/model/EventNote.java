...
public class EventNote
  ...
  */
  ...
  /**
   Compare this EventNote object to another, using the key field(s) for comparison.
  ...
  public int compareTo (Object obj2) {
    ...
    if (comparison == 0) {
      if (! obj2.getClass().getSimpleName().equals ("EventNote")) {
        comparison = 1;
      }
    }
 
    EventNote eventNote2 = (EventNote)obj2;
    if (comparison == 0) {
      if (this.getNoteForYmd() == null) {
        comparison = -1;
      }
      else
      if (eventNote2.getNoteForYmd() == null) {
        comparison = 1;
      } else {
        comparison = (this.getNoteForYmd().compareTo(eventNote2.getNoteForYmd()));
      }
    }
    if (comparison == 0) {
      if (this.getNoteFrom() == null) {
        comparison = -1;
      }
      else
      if (eventNote2.getNoteFrom() == null) {
        comparison = 1;
      } else {
        comparison = (this.getNoteFrom().compareTo(eventNote2.getNoteFrom()));
      }
    }
    if (comparison == 0) {
      if (this.getNoteVia() == null) {
        comparison = -1;
      }
      else
      if (eventNote2.getNoteVia() == null) {
        comparison = 1;
      } else {
        comparison = (this.getNoteVia().compareTo(eventNote2.getNoteVia()));
      }
    }
