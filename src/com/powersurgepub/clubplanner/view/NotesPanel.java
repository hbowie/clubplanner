...
public class NotesPanel
  ...
  /**
   The constructor.
   */
  public NotesPanel(JFrame frame, LinkTweaker linkTweaker) {
   ...
   */
    ...
    // Button to add a note with the note window
    gb.setColumnWeight(0.0);
    gb.setWidth(1);
    gb.setTopInset(8);
    addNoteButton.setActionCommand("add-note-button");
    addNoteButton.addActionListener(this);
    gb.add(addNoteButton);
    ...
    noteWindow = new NoteWindow(frame, linkTweaker, this);
 
  }
  
  public void actionPerformed(ActionEvent evt) {
    if (evt.getActionCommand().equals("add-note-button")) {
      windowMenuManager = WindowMenuManager.getShared();
      windowMenuManager.add(noteWindow);
      windowMenuManager.locateUpperLeftAndMakeVisible
        (this, noteWindow);
    }
  }
  
  public void addNote(EventNote newNote) {
    StringBuilder note = new StringBuilder();
    note.append("-- from ");
    note.append(newNote.getNoteFrom());
    note.append(" on ");
    note.append(newNote.getNoteFor());
    note.append(" via ");
    note.append(newNote.getNoteVia());
    note.append(GlobalConstants.LINE_FEED_STRING);
    note.append(GlobalConstants.LINE_FEED_STRING);
    note.append(newNote.getNote());
    note.append(GlobalConstants.LINE_FEED_STRING);
    note.append(GlobalConstants.LINE_FEED_STRING);
    note.append(notesJTextArea.getText());
    notesJTextArea.setText(note.toString());
  }
